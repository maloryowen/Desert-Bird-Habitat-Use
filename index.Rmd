...
#mesohabitats
#Fine  mesohabitats
hist.mesofine <- ggplot(site, aes(x=mesohabitat, fill = as.factor(season))) + 
  geom_histogram(stat="count") + 
  facet_grid(.~season) + 
  scale_fill_manual(values = c("#FFF47F", "#7FB2FF")) +
  theme_classic() + 
...
hist.meso <- ggarrange(hist.mesofine, hist.mesofive, hist.mesothree, hist.mesotwo, ncol=2, nrow=2) 
hist.meso

#diversity 
#species
specieshist <- ggplot(site, aes(x=species)) + geom_bar() + theme_classic() + 
  theme(axis.text.x = element_text(angle = 60, hjust = 1, size=12)) 

#order
orderhist <- ggplot(site, aes(x=order)) + geom_bar() +theme_classic() + 
  theme(axis.text.x = element_text(angle = 60, hjust = 1, size=12)) 

#family
familyhist <- ggplot(site, aes(x=family)) + geom_bar() + theme_classic() +
  theme(axis.text.x = element_text(angle = 60, hjust = 1, size=12)) 

#trophic
trophichist <- ggplot(site, aes(x=trophic.guild)) + theme_classic() + 
  theme(axis.text.x = element_text(angle = 60, hjust = 1, size=12)) 

#diversity histograms
divhist <- ggarrange(specieshist, familyhist, orderhist, trophichist, ncol=2, nrow=2)
divhist

#histogram of bird distance from transect
disthist <- ggplot(site, aes(x=distance)) + geom_bar()  + theme_classic() + 
  theme(axis.text.x = element_text(angle = 60, hjust = 1, size=12)) 
disthist
