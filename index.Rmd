...
ssp.bar <- ggarrange(meso.ssp.bar.3, meso.ssp.bar.2, beha.ssp.bar, nrow=3, ncol=1)
```
...
tro.bar <- ggarrange(meso.tro.bar.3, meso.tro.bar.2, beha.tro.bar, nrow=3, ncol=1)
```
...
mig.bar <- ggarrange(meso.mig.bar.3, meso.mig.bar.2, beha.mig.bar, nrow=3, ncol=1)

ssp.fun.bar <- ggarrange(ssp.bar, tro.bar, mig.bar, nrow=1, ncol=3)
ssp.fun.bar
```
